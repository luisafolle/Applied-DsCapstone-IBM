...
print("Accuracy on test data: " + str(logreg_cv.score(X_test, Y_test)))
...
# *Scores for train and test data are very close, indicating that over-fitting was avoided. Both accuracy for Decision-Tree method show that it is the method performing the best.*
